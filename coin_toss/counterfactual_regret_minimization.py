...
def counterfactual_regret_minimization(nodes, game, gameState, p0, p1):
    ...
    for a in range(node.getActionCount()):
        ...
        util[a] = -1.0 * counterfactual_regret_minimization(nodes, game, newState, [p0 * strategy[a], p0][player], [p1, p1 * strategy[a]][player])
